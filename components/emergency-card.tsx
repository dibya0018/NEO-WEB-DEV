...
export function EmergencyCard() {
  ...
  return (
    <section id="emergency-card" className="py-20 relative bg-white overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-br from-gray-50 to-transparent rounded-full blur-3xl opacity-30" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <div className="absolute -bottom-8 -right-8 -z-10 w-full h-full rounded-2xl bg-gradient-to-br from-gray-200/30 to-gray-300/20 blur-3xl" />
            </div>
